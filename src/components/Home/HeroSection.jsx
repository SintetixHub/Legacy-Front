...
const HeroSection = () => {
  ...
  const divClasses = ["flex", "justify-between", "items-center"].join(" ");

  return (
    <div className={divClasses}>
      <div className="p-6">
        <h1 className="text-4xl font-bold open-sans mb-4">
          Un nuevo blog ha nacido
        </h1>
        <div className="mt-4 mb-4">
          <span className="italic text-blue-400 open-sans m-2">
            #Tendencias
          </span>
          <span className="italic text-blue-400 open-sans">#blog</span>
        </div>
